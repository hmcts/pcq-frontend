...
EXIT_STATUS=0
DEBUG=codeceptjs:* BROWSER_GROUP=chrome yarn test-crossbrowser-e2e || EXIT_STATUS=$?
# DEBUG=codeceptjs:* BROWSER_GROUP=microsoftEdge yarn test-crossbrowser-e2e || EXIT_STATUS=$?
