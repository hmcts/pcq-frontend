...
let ApplicantEthnicBackgroundWhite;

describe('ApplicantEthnicBackgroundWhite', () => {
    before(() => {
        const steps = initSteps([`${__dirname}/../../app/steps/ui/ethnicwhite`]);
        ApplicantEthnicBackgroundWhite = steps.ApplicantEthnicBackgroundWhite;
    });
