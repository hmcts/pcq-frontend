...
let ApplicantEthnicBackgroundOther;

describe('ApplicantEthnicBackgroundOther', () => {
    before(() => {
        const steps = initSteps([`${__dirname}/../../app/steps/ui/ethnicother`]);
        ApplicantEthnicBackgroundOther = steps.ApplicantEthnicBackgroundOther;
    });
