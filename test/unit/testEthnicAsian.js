...
let ApplicantEthnicBackgroundAsian;

describe('ApplicantEthnicBackgroundAsian', () => {
    before(() => {
        const steps = initSteps([`${__dirname}/../../app/steps/ui/ethnicasian`]);
        ApplicantEthnicBackgroundAsian = steps.ApplicantEthnicBackgroundAsian;
    });
